							...
							<td width="100%" class="tableborder">
								<table width="100%" cellspacing="0" cellpadding="0" border="0">
									...
									<tr>
										...
										<td width="25%" class="attributecell">
											<p initRoller="true"> INITIATIVE: <xsl:value-of select="init"/></p>
										</td>
									</tr>
									<tr>
										<td width="25%" class="attributecell">
										...
										<td width="25%" class="attributecell">
											<p initRoller="true">
												<xsl:choose>
												<xsl:when test="magenabled = 'True'"> ASTRAL INIT: <xsl:value-of select="astralinit"/>
												</xsl:when>
									...
									<tr>
										...
										<td width="25%" class="attributecell">
											<p initRoller="true"> RIGGER INIT: <xsl:value-of select="riggerinit" />
											</p>
										</td>
									</tr>
									<tr>
                ...
                <td>
                  <table width="100%" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tr>
                      ...
                      <td width="40%">
                        <strong>REQUIRES PROGRAM</strong>
                      </td>
                      <td width="20%" style="text-align:center;"> </td>
                    </tr>
