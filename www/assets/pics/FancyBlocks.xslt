...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="http://exslt.org/common">
	...
	<xsl:include href="assets/pics/xt.PreserveLineBreaks.xslt"/>
	...
	<xsl:template name="print_attributes">
		<table class="stats general">
			...
			<tr><td colspan="4"><hr /></td></tr>
            <tr><td colspan="2">Initiative</td><td colspan="2" onClick="rollInitative(this);"><strong><xsl:value-of select="init" /></strong></td></tr>
	...
	<xsl:template name="print_half_active_skills">
		...
		Test: <xsl:value-of select="count($sorted_skills)" />
